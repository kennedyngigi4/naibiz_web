                ...
                <div className="card-body mt-n3 p-0">
                    <div className="avatarBox position-relative mb-4">
                        <div className="square--100 circle bg-transparents mx-auto p-2 z-2">
                            {business?.created_by?.profile_image ? (
                              <Image src={business?.created_by?.profile_image} width={0} height={0} sizes='100vw' style={{ width: '100%', height: '100%' }} className="img-fluid circle" alt={business?.name || "Nairobi Business Listing"} />
                            ) : (
                                <div className="d-flex align-items-center justify-content-center w-100 h-100">
                                    <Image src="/icons/user.png" width={0} height={0} sizes='100vw' style={{ width: '100%', height: '100%' }} className="img-fluid circle" alt={business?.name || "Nairobi Business Listing"} />
                                </div>
                            )}
                            {/* {business?.created_by} */}
                        </div>
                        <div className="listingInfo text-center">
                            ...
                            <h6 className="mb-0 capitalize">{ business?.created_by?.fullname}</h6>
                        </div>
                    </div>
                    ...
                    <div className="headerLast">
                      {business?.is_open ? 
                        (<span className="badge badge-xs badge-success rounded-pill">Now Open</span>) 
                          : (<span className="badge badge-xs badge-danger rounded-pill">Closed</span>)
                      }    
                    </div>
                </div>
                <div className="card-body p-0">
                    <div className="openingsInfo">
                        {business?.hours?.map((item:HoursModel,index:number)=>{
                            return(
                                <div className="py-3 px-3 border-top" key={index}>
                                    <div className="infoFlexio d-flex align-items-center justify-content-between">
                                        ...
                                        <p className="text-dark text-sm fw-medium lh-base mb-0">{item?.opening_time} to {item?.closing_time}</p>
                                    </div>
                                </div>
                            )
                        })}
